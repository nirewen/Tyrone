...
import { format, regions, regionEmojis, emojify } from './serverinfo.utils/utils'
...
export async function run (msg) {
    ...
    let { name, id, icon, memberCount, region, roles: { cache: roles }, channels: { cache: channels }, ownerID, joinedAt, createdAt } = msg.guild
    ...
    if (!regionEmoji) {
        ...
        regionEmoji = ':earh_americas: Desconhecida'
    } else
        regionEmoji = regionEmoji[0]
